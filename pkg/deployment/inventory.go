...
func getAnsibleUser(instance *dataplanev1.OpenStackDataPlaneRole, nodeName string) string {
	if instance.Spec.Nodes[nodeName].AnsibleUser != "" {
		return instance.Spec.Nodes[nodeName].AnsibleUser
	}
...
func getAnsiblePort(instance *dataplanev1.OpenStackDataPlaneRole, nodeName string) string {
	if instance.Spec.Nodes[nodeName].AnsiblePort > 0 {
		return strconv.Itoa(instance.Spec.Nodes[nodeName].AnsiblePort)
	}
...
func getAnsibleNetworkConfig(instance *dataplanev1.OpenStackDataPlaneRole, nodeName string) dataplanev1.NetworkConfigSection {
...
func getAnsibleNetworks(instance *dataplanev1.OpenStackDataPlaneRole, nodeName string) []infranetworkv1.IPSetNetwork {
...
func getAnsibleVars(helper *helper.Helper, instance *dataplanev1.OpenStackDataPlaneRole,
	...
	for key, val := range instance.Spec.Nodes[nodeName].AnsibleVars {
		var v interface{}
...
func resolveNodeAnsibleVars(node *dataplanev1.NodeTemplate, host *ansible.Host, group *ansible.Group) error {
	ansibleVarsData := make(map[string]interface{})
